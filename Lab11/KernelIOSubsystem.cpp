...
struct IORequest
{
    ...
    Type type;
    Priority priority;
    size_t blockNumber; // ส ำหรับ disk
    size_t dataSize;
    vector<uint8_t> data;
...
public:
    ...
    bool processNext()
    {
        ...
        // จ ำลองเวลำในกำรประมวลผล
        // (ใน real system จะมีกำรเข้ำถึง disk จริง)
        return true;
    }
...
{
private:
    // TODO: ใช้ priority_queue หรือ 3 queues แยกตำม priority
...
public:
    ...
    void addRequest(IORequest req)
    {
        // TODO: เพม request ลงใน queue ตำม priority
        switch (req.priority)
        {
    ...
    // TODO: เขียน processNext() โดยให้ HIGH priority กอน
    bool processNext()
    {
...
public:
    ...
    void displayStatus()
    {
        ...
        cout << (isEmpty() ? "EMPTY" : isFull() ? "FULL"
                                                : "OK")
             << endl;
    }
};
...
public:
    ...
    void evict()
    {
        // หำ entry ที่ lastAccess เกำทสด
...
int main()
{
    ...
    // ===== TEST I/O CACHE =====
    cout << "\n========== I/O CACHE ==========" << endl;
    IOCache cache(3); // cache ขนำด 3 blocks
