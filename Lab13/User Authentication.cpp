/*
* Program 5.1 —PAM-style Authentication: hashed passwords + TOTP + lockout
* REAL SITUATION: Models /etc/shadow salted hashing, Google Authenticator
* TOTP, and pam_tally2 / faillock lockout on Linux systems.
*/
#include <iostream>
#include <string>
