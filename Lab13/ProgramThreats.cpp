/*
* Program 2.1 —Buffer Overflow + Trojan Horse + Logic Bomb
* REAL SITUATION:
* Buffer overflow —basis of Morris Worm (1988)
* Logic bomb —UBS PaineWebber 2002 (Roger Duronio case)
* Trojan —malicious code hidden inside legitimate utility
*/
#include <iostream>
#include <cstring>
#include <string>
