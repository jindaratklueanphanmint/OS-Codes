/*
* Program 4.1 —Encryption Pipeline: Caesar →XOR →RSA →MAC
* REAL SITUATION: Same principles used in OpenSSL, Windows CryptoAPI,
* and every TLS 1.3 handshake establishing HTTPS connections.
*/
#include <iostream>
#include <string>
#include <vector>
